...
//		super.price = price; // 부모가 private 직접접근 X 
		
		// 3. 부모의 setter 메서드를 호출하여 초기화
		//		- 부모 클래스에서 setter 메서드를 제공하면
//				- 자식 클래스 에서 부모의 setter 메서드를 통해 초기화 가능
		super.setpCode(brand);
		this.setpCode(pCode);
		setName(name); // this 생략가능 
	}
