...
public class Car {
	 ...
	 * [ ]default(명시 X)  : 같은 패키지 내에서만 접근 가능
	 ...
	 * - 생성자가 하나라도 있으면 컴파일러가 기본 생성자를 추가하지 않음 
	 * */
	...
	public Car(String color, String gearType, int door) {
		...
		/*
		 * this : 자신을 가르키는 참조변수. 객체 주소가 저장되어 있음
	...
	public Car(String color, String gearTyep) {
		this.color = color;
		this.gearType = gearTyep;
	}
	// 오버라이딩 : 부모 클래스의매서드를 자식 클래스에서 다시 재정의
