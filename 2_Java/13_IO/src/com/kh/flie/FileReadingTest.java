...
public class FileReadingTest {
	...
	String outfileName = "src/test_output.txt";
...
//		f.fileRead2();
	...
	public void fileRead() {
		...
		try(FileReader fr = new FileReader(fileName)) {
			...
			int data = 0;
			while((data = fr.read()) != -1) {// 파일을 하나씩 끌어와서 
	...
	public void fileRead2() {
		try(FileReader fr = new FileReader(fileName); // close 해야하는걸 모두 괄호 안으로 
