package com.kh.arry.practice2;

import java.util.Arrays;
import java.util.Scanner;
import com.kh.arry.practice2.controller.MemberController;
import com.kh.arry.practice2.model.Member;
...
public class Application {
	...
	/*
	 * 회원 수가 3명이 최대 등록 가능 
	 * 3명 모두 등록되면 "회원 수가 모두 꽉 찼기 때문에 일부 매뉴만 오픈됩니다." 와 함께
	...
	public void mainMenu() {
		...
		while(ck) {
			...
			System.out.printf("최대 등록 가능한 회원 수는 3명입니다\n현재 등록된 회원수는 %d명 입니다.\n", mc.count);
			if(mc.count < 3) {
			System.out.println("1. 새 회원 등록 ");
			}else {
			System.out.println("회원 수가 모두 꽉 찼기 때문에 일부 매뉴만 오픈됩니다.");
			}
	...
	/*
	 * 아이디를 입력 받았는데 기존 멤버 배열에 아이디가 있는 경우(int ? = Arrays.asList().indexOf()
