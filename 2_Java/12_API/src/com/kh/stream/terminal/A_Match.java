 ...
 * - anyMatch : 최소한 한개의 요소가 매개값으로 주어진 조건을 만족하는지 조사 
...
public class A_Match {
	...
	public void method1() {
		...
		System.out.println("3의 배수의 값이 하나라도 있는가 ? : " + result); // true
		
		result = Arrays.stream(values)
				   .noneMatch(value -> value % 5 == 0);
		System.out.println("5의 배수의 값이 하나도 없는가 ? : " + result); // true 
	...
	public void method2() {
		...
		System.out.println("나이가 20살 이상인 학생들이 모두 남자인가? : " + check);
		...
		System.out.println("남학생들 중에 평균이 70점 이상인 학생이 한 명이라도 존재하는가? : " + check);
